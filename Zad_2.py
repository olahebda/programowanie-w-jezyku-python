...
class Library:
    ...
    def __str__(self):
        return (f"Library address: {self.city}, {self.street}, "
                f"{self.zip_code}, Phone: {self.phone},"
                f" Hours: {self.open_hours}")
...
class Employee:
    ...
    def __str__(self):
        return (f"Employee: {self.first_name} {self.last_name},"
                ...
                f"{self.zip_code}, Phone_number: {self.phone}")
...
class Book:
    ...
    def __str__(self):
        return (
            f"Book from {
                self.library}, " f"Published {
                self.publication_date} by: {
                self.author_name}," f" {
                    self.author_surname}, Number of Pages: {
